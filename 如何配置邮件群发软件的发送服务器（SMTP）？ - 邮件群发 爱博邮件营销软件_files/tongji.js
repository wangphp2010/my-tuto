...
{
	var unit_id     = "361920";
	var client_ip   = "195.59.70.203";
	var server_time = "1378677359";
	var verify_code = "59a653f5";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	document.write( "<a href='#' onClick=\""+open_win+"\">&#32473;&#25105;&#30041;&#35328;</a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/361920/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
