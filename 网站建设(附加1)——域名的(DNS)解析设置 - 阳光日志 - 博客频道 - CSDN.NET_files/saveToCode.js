...
$(function()
{
    (function(){
        ...
        oBlog_code.hoverStart = (function()
        {
            ...
            {
                $(this).append('<div class="save_code"><img src="http://static.blog.csdn.net/images/save_snippets.png"/></div>');
                return false;
            });
            ...
            $(document).delegate('.save_code','click',function(ev)
            {
                ...
                if(currentUserName)
                {
                    if($(".gist_edit").length == 0)
                    {
                        ...
                        '</li></ul></div><div class="bottom-bar"><button class="btn-submit btn-cancel" type="button">取消</button><button class="btn-submit btn-confirm" type="submit">确定</button></div></div></div>';
