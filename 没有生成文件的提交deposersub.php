...
(nom,email,titre,telephone,region,departement,arrondissement,codepo,ville,prix,categorie $suru,papro,offre,neirong,createtime,uptime,pathtu,clientip)VALUES";
$insert_sql .= "
('$nom','$email','$titre','$telephone','$region','$departement','$arrondissement','$codepo','$ville','$prix','$categorie' $suru2,'$papro','$offre','$neirong','$createtime','$createtime','$destination','$ip')";


if(mysql_query($insert_sql)){
$iidd = mysql_insert_id();//马上获取新数据的id号

if($categorie=="Immobilier")$chemin="http://monpub.com/immobilier/immobilier.php?id=".$iidd;

if($categorie=="Voiture")$chemin="http://monpub.com/vehicule/vehicule.php?id=".$iidd;

if($categorie=="Moto")$chemin="http://monpub.com/vehicule/vehicule.php?id=".$iidd;

if($categorie=="Fondsdecommerce")$chemin="http://monpub.com/fond de commerce/fond de commerce.php?id=".$iidd;


if($categorie=="BureauCommerce")$chemin="http://monpub.com/bureau/bureaulocalcommerce.php?id=".$iidd;

if($categorie=="Travail")$chemin="http://monpub.com/travail/emploi.php?id=".$iidd;

if($categorie=="Autre")$chemin="http://monpub.com/autre/autre.php?id=".$iidd;


$path="UPDATE db415861577.imo SET path ='$chemin' WHERE id = '$iidd'";
...
<title>mon pub deposer des annonces gratuitement</title>
<style type="text/css">
<!--
.STYLE1 {font-family: "Times New Roman", Times, serif; font-weight: bold; font-size: 30px; }
-->
...
{	 $too = "philippe660@gmail.com"; 
    ...
    $contentt .= "Monpub.com -- 终于有人来我们的网站发小广告了,哈------<br />为建成免费发annonce而不断努力着。<br /><br />
